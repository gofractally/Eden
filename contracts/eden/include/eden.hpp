...
namespace eden
{
   ...
   EDEN_ACTIONS(
       ...
       eden_auth_action(inductmeetin, 1, account, id, keys, data, old_data),
       eden_auth_action(inductprofil,
                        2,
                        id,
                        new_member_profile,
                        ricardian_contract(inductprofil_ricardian)),
       eden_auth_action(inductvideo,
                        3,
                        account,
                        id,
                        video,
                        ricardian_contract(inductvideo_ricardian)),
       eden_auth_action(inductendors,
                        4,
                        account,
                        id,
                        induction_data_hash,
       ...
       eden_auth_action(electopt, 5, member, participating),
       action(electseed, btc_header),
       eden_auth_action(electmeeting, 6, account, round, keys, data, old_data),
       eden_auth_action(electvote, 7, round, voter, candidate),
       eden_auth_action(electvideo, 8, round, voter, video),
       ...
       eden_auth_action(inductcancel, 9, account, id, ricardian_contract(inductcancel_ricardian)),
