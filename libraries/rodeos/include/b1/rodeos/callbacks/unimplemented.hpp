...
namespace b1::rodeos
{
   ...
   struct unimplemented_callbacks
   {
      ...
      void get_resource_limits(int64_t, int, int, int)
      {
         return unimplemented<void>("get_resource_limits");
      }
      void set_resource_limits(int64_t, int64_t, int64_t, int64_t)
      {
         return unimplemented<void>("set_resource_limits");
      }
      int64_t set_proposed_producers(int, int)
      {
         return unimplemented<int64_t>("set_proposed_producers");
      }
      int get_blockchain_parameters_packed(int, int)
      {
         return unimplemented<int>("get_blockchain_parameters_packed");
      }
      void set_blockchain_parameters_packed(int, int)
      {
         return unimplemented<void>("set_blockchain_parameters_packed");
      }
...
#define DB_SECONDARY_INDEX_METHODS_SIMPLE(IDX)                                                     \
   int db_##IDX##_store(int64_t, int64_t, int64_t, int64_t, int)                                   \
   {                                                                                               \
...
#undef DB_SECONDARY_INDEX_METHODS_SIMPLE
      ...
      int64_t get_permission_last_used(int64_t, int64_t)
      {
         return unimplemented<int64_t>("get_permission_last_used");
      }
      int64_t get_account_creation_time(int64_t)
      {
         return unimplemented<int64_t>("get_account_creation_time");
      }
      ...
      void send_context_free_inline(int, int)
      {
         return unimplemented<void>("send_context_free_inline");
      }
      void send_deferred(int, int64_t, int, int, int32_t)
      {
         return unimplemented<void>("send_deferred");
      }
      int cancel_deferred(int) { return unimplemented<int>("cancel_deferred"); }

      // context_free_api
      int get_context_free_data(int, int, int)
      {
         return unimplemented<int>("get_context_free_data");
      }
