...
namespace b1::rodeos
{
   ...
   struct compiler_builtins_callbacks
   {
      ...
      void __udivti3(legacy_ptr<unsigned __int128> ret,
                     uint64_t la,
                     uint64_t ha,
                     uint64_t lb,
                     uint64_t hb)
      ...
      void __umodti3(legacy_ptr<unsigned __int128> ret,
                     uint64_t la,
                     uint64_t ha,
                     uint64_t lb,
                     uint64_t hb)
      ...
      void __negtf2(legacy_ptr<float128_t> ret, uint64_t la, uint64_t ha)
      {
      ...
      void __extendsftf2(legacy_ptr<float128_t> ret, float f)
      {
         *ret = f32_to_f128(to_softfloat32(f));
      }

      void __extenddftf2(legacy_ptr<float128_t> ret, double d)
      {
      ...
      void __fixunssfti(legacy_ptr<unsigned __int128> ret, float a)
      {
         *ret = ___fixunssfti(to_softfloat32(a).v);
      }

      void __fixunsdfti(legacy_ptr<unsigned __int128> ret, double a)
      {
