...
void view_test(bool reload_session)
{
   ...
   BOOST_REQUIRE_EQUAL(get_matching(*view, 0xf00df00d, {0x10}),
                       get_matching2(*view, 0xf00df00d, {0x10}));
   ...
   BOOST_REQUIRE_EQUAL(get_matching(*view, 0xf00df00d, {0x20}),
                       get_matching2(*view, 0xf00df00d, {0x20}));
}  // view_test()
