...
namespace eosio
{
   ...
   template <typename Stream>
   inline datastream<Stream>& operator>>(datastream<Stream>& ds,
                                         shared_memory<datastream<Stream>>& dest)
   {
      unsigned_int size;
      ds >> size;
   ...
   inline datastream<Stream1>& operator<<(datastream<Stream1>& ds,
                                          const shared_memory<datastream<Stream2>>& obj)
   {
   ...
   template <typename Stream>
   inline datastream<Stream>& operator>>(datastream<Stream>& ds,
                                         shared_memory<std::string_view>& dest)
   {
      unsigned_int size;
      ds >> size;
   ...
   template <typename Stream>
   inline datastream<Stream>& operator<<(datastream<Stream>& ds,
                                         const shared_memory<std::string_view>& obj)
   {
