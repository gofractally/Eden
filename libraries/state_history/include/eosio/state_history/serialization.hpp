...
namespace fc
{
   ...
   datastream<ST>& history_serialize_container(datastream<ST>& ds,
                                               const chainbase::database& db,
                                               const T& v)
   {
   ...
   datastream<ST>& history_context_serialize_container(datastream<ST>& ds,
                                                       const chainbase::database& db,
                                                       const P& context,
   ...
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const eosio::state_history::big_vector_wrapper<T>& obj)
   {
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_serial_wrapper<eosio::chain::account_object>& obj)
   {
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_serial_wrapper<eosio::chain::code_object>& obj)
   {
      fc::raw::pack(ds, fc::unsigned_int(0));
      fc::raw::pack(ds, as_type<uint8_t>(obj.obj.vm_type));
      fc::raw::pack(ds, as_type<uint8_t>(obj.obj.vm_version));
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_context_wrapper<eosio::chain::table_id_object,
                                                            eosio::chain::key_value_object>& obj)
   {
      fc::raw::pack(ds, fc::unsigned_int(0));
   ...
   template <typename ST, typename T>
   datastream<ST>& serialize_secondary_index(datastream<ST>& ds,
                                             const eosio::chain::table_id_object& context,
                                             const T& obj)
   {
      fc::raw::pack(ds, fc::unsigned_int(0));
   ...
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_context_wrapper<eosio::chain::table_id_object,
                                                            eosio::chain::index64_object>& obj)
   {
   ...
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_context_wrapper<eosio::chain::table_id_object,
                                                            eosio::chain::index128_object>& obj)
   {
      return serialize_secondary_index(ds, obj.context, obj.obj);
   }
   ...
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_context_wrapper<eosio::chain::table_id_object,
                                                            eosio::chain::index256_object>& obj)
   {
      return serialize_secondary_index(ds, obj.context, obj.obj);
   }
   ...
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_context_wrapper<eosio::chain::table_id_object,
                                                            eosio::chain::index_double_object>& obj)
   {
      return serialize_secondary_index(ds, obj.context, obj.obj);
   }
   ...
   datastream<ST>& operator<<(
       datastream<ST>& ds,
       const history_context_wrapper<eosio::chain::table_id_object,
                                     eosio::chain::index_long_double_object>& obj)
   {
      return serialize_secondary_index(ds, obj.context, obj.obj);
   }
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_serial_wrapper<eosio::chain::kv_object>& obj)
   {
      fc::raw::pack(ds, fc::unsigned_int(0));
       ...
       const history_serial_wrapper<eosio::chain::shared_producer_authority_schedule>& obj)
   {
      ...
      history_serialize_container(
          ds, obj.db,
          as_type<eosio::chain::shared_vector<eosio::chain::shared_producer_authority>>(
              obj.obj.producers));
      return ds;
   }
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_serial_wrapper<eosio::chain::chain_config>& obj)
   {
      fc::raw::pack(ds, fc::unsigned_int(0));
       ...
       const history_serial_wrapper<eosio::chain::global_property_object>& obj)
   {
      ...
      fc::raw::pack(
          ds, as_type<optional<eosio::chain::block_num_type>>(obj.obj.proposed_schedule_block_num));
      fc::raw::pack(ds, make_history_serial_wrapper(
                            obj.db, as_type<eosio::chain::shared_producer_authority_schedule>(
                                        obj.obj.proposed_schedule)));
      fc::raw::pack(ds, make_history_serial_wrapper(
                            obj.db, as_type<eosio::chain::chain_config>(obj.obj.configuration)));
   ...
   datastream<ST>& operator<<(
       datastream<ST>& ds,
       const history_serial_wrapper<
           eosio::chain::protocol_state_object::activated_protocol_feature>& obj)
   {
      fc::raw::pack(ds, fc::unsigned_int(0));
   ...
   datastream<ST>& operator<<(
       datastream<ST>& ds,
       const history_serial_wrapper<eosio::chain::protocol_state_object>& obj)
   {
      fc::raw::pack(ds, fc::unsigned_int(0));
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_serial_wrapper<eosio::chain::shared_key_weight>& obj)
   {
   ...
   {
      fc::raw::pack(ds, make_history_serial_wrapper(
                            obj.db, as_type<eosio::chain::permission_level>(obj.obj.permission)));
      fc::raw::pack(ds, as_type<uint16_t>(obj.obj.weight));
      return ds;
   }
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_serial_wrapper<eosio::chain::wait_weight>& obj)
   {
                              ...
                              const history_serial_wrapper<eosio::chain::permission_object>& obj)
   {
      ...
      fc::raw::pack(ds, make_history_serial_wrapper(
                            obj.db, as_type<eosio::chain::shared_authority>(obj.obj.auth)));
      return ds;
   }
       ...
       const history_serial_wrapper<eosio::chain::resource_limits::resource_usage_object>& obj)
   {
      ...
      fc::raw::pack(ds, as_type<uint64_t>(obj.obj.owner.to_uint64_t()));
      fc::raw::pack(ds, make_history_serial_wrapper(
                            obj.db, as_type<eosio::chain::resource_limits::usage_accumulator>(
                                        obj.obj.net_usage)));
      fc::raw::pack(ds, make_history_serial_wrapper(
                            obj.db, as_type<eosio::chain::resource_limits::usage_accumulator>(
                                        obj.obj.cpu_usage)));
   ...
   datastream<ST>& operator<<(
       datastream<ST>& ds,
       const history_serial_wrapper<eosio::chain::resource_limits::resource_limits_state_object>&
           obj)
   {
      fc::raw::pack(ds, fc::unsigned_int(0));
      fc::raw::pack(ds, make_history_serial_wrapper(
       ...
       const history_serial_wrapper<eosio::chain::resource_limits::elastic_limit_parameters>& obj)
   {
      ...
      fc::raw::pack(
          ds, make_history_serial_wrapper(
                  obj.db, as_type<eosio::chain::resource_limits::ratio>(obj.obj.contract_rate)));
      fc::raw::pack(
          ds, make_history_serial_wrapper(
                  obj.db, as_type<eosio::chain::resource_limits::ratio>(obj.obj.expand_rate)));
      return ds;
   }
   ...
   datastream<ST>& operator<<(
       datastream<ST>& ds,
       const history_serial_wrapper<eosio::chain::resource_limits::resource_limits_config_object>&
           obj)
   {
      fc::raw::pack(ds, fc::unsigned_int(0));
      fc::raw::pack(ds,
                    make_history_serial_wrapper(
                        obj.db, as_type<eosio::chain::resource_limits::elastic_limit_parameters>(
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_serial_wrapper<eosio::chain::action>& obj)
   {
      fc::raw::pack(ds, as_type<uint64_t>(obj.obj.account.to_uint64_t()));
      fc::raw::pack(ds, as_type<uint64_t>(obj.obj.name.to_uint64_t()));
      history_serialize_container(
          ds, obj.db, as_type<std::vector<eosio::chain::permission_level>>(obj.obj.authorization));
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_serial_wrapper<eosio::chain::action_receipt>& obj)
   {
      ...
      history_serialize_container(
          ds, obj.db, as_type<flat_map<eosio::chain::name, uint64_t>>(obj.obj.auth_sequence));
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_serial_wrapper<eosio::chain::account_delta>& obj)
   {
      fc::raw::pack(ds, as_type<uint64_t>(obj.obj.account.to_uint64_t()));
   ...
   inline fc::optional<uint64_t> cap_error_code(const fc::optional<uint64_t>& error_code)
   {
      ...
      const uint64_t upper_limit =
          static_cast<uint64_t>(eosio::chain::system_error_code::generic_system_error);
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const history_context_wrapper<bool, eosio::chain::action_trace>& obj)
   {
      ...
      {
         fc::raw::pack(ds, make_history_serial_wrapper(
                               obj.db, as_type<eosio::chain::action_receipt>(*obj.obj.receipt)));
      }
      fc::raw::pack(ds, as_type<uint64_t>(obj.obj.receiver.to_uint64_t()));
      fc::raw::pack(
          ds, make_history_serial_wrapper(obj.db, as_type<eosio::chain::action>(obj.obj.act)));
      ...
      history_serialize_container(
          ds, obj.db, as_type<flat_set<eosio::chain::account_delta>>(obj.obj.account_ram_deltas));
      history_serialize_container(
          ds, obj.db, as_type<flat_set<eosio::chain::account_delta>>(obj.obj.account_disk_deltas));
      ...
      fc::raw::pack(ds, as_type<fc::optional<uint64_t>>(
                            debug_mode ? obj.obj.error_code : cap_error_code(obj.obj.error_code)));
   ...
   datastream<ST>& operator<<(
       ...
       const history_context_wrapper<std::pair<uint8_t, bool>,
                                     eosio::state_history::augmented_transaction_trace>& obj)
   {
      ...
      if (trace.receipt)
      {
         if (trace.failed_dtrx_trace &&
             trace.receipt->status.value == eosio::chain::transaction_receipt_header::soft_fail)
      ...
      {
         fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<eosio::chain::account_delta>(
      ...
      fc::raw::pack(ds, as_type<fc::optional<std::string>>(e));
      fc::raw::pack(ds, as_type<fc::optional<uint64_t>>(
                            debug_mode ? trace.error_code : cap_error_code(trace.error_code)));
      ...
      if (trace.failed_dtrx_trace)
      {
         ...
         fc::raw::pack(  //
             ds, make_history_context_wrapper(obj.db, context,
                                              eosio::state_history::augmented_transaction_trace{
                                                  trace.failed_dtrx_trace, obj.obj.partial}));
      }
   ...
   {
      std::pair<uint8_t, bool> context =
          std::make_pair(eosio::chain::transaction_receipt_header::hard_fail, obj.context);
   ...
   template <typename ST>
   datastream<ST>& operator<<(datastream<ST>& ds,
                              const eosio::state_history::get_blocks_result_v0& obj)
   {
