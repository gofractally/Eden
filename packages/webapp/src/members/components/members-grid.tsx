...
export const MembersGrid = ({ members, dataTestId }: Props) => {
    const containerClass = `grid grid-cols-1 max-w-xs sm:max-w-xl md:max-w-none sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 mx-auto dark:bg-gray-600`;
    return (
...
export const MemberSquare = ({ member }: { member: MemberData }) => {
    const cardClass =
        "group border border-gray-300 dark:border-gray-500 dark:bg-gray-500 rounded-md shadow-md overflow-hidden text-gray-800 dark:text-gray-200";
    const memberCard = (
