...
# Command for creating new test account
# cleos -u https://waxtest.eosn.io system newaccount edev --transfer test3.edev EOS5s3s1cAxBMFqTE5tDX1FtPQA3Artk4s3xMjgpbQBGBED9FM1zp --stake-net "400.00000000 WAX" --stake-cpu "400.00000000 WAX" --buy-ram-kbytes 7168
